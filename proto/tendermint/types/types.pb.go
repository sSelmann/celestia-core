...
type ProposerRoundInfo struct {
	...
	BlockReceived    bool   `protobuf:"varint,4,opt,name=block_received,json=blockReceived,proto3" json:"block_received,omitempty"`
}
...
func (m *ProposerRoundInfo) GetProposalReceived() bool {
	if m != nil {
		return m.ProposalReceived
	}
	return false
}

func (m *ProposerRoundInfo) GetBlockReceived() bool {
	if m != nil {
		return m.BlockReceived
	}
	return false
}
...
type Commit struct {
	...
	// round_proposers tracks all proposers and their proposal status for each round
	// that occurred before the block was committed. This allows tracking which
	// validators missed their proposal opportunity.
	RoundProposers []ProposerRoundInfo `protobuf:"bytes,5,rep,name=round_proposers,json=roundProposers,proto3" json:"round_proposers"`
}
...
func (m *Commit) GetRoundProposers() []ProposerRoundInfo {
	if m != nil {
		return m.RoundProposers
	}
	return nil
}
...
func (m *ExtendedCommit) GetRoundProposers() []ProposerRoundInfo {
	if m != nil {
		return m.RoundProposers
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ProposerRoundInfo)(nil), "tendermint.types.ProposerRoundInfo")
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}
...
func (m *Commit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.RoundProposers) > 0 {
		for iNdEx := len(m.RoundProposers) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.RoundProposers[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *Commit) Size() (n int) {
	...
	if len(m.RoundProposers) > 0 {
		for _, e := range m.RoundProposers {
			l = e.Size()
			n += 1 + l + sovTypes(uint64(l))
		}
	}
...
func (m *ProposerRoundInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProposalReceived", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ProposalReceived = bool(v != 0)
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlockReceived", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *Commit) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RoundProposers", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RoundProposers = append(m.RoundProposers, ProposerRoundInfo{})
			if err := m.RoundProposers[len(m.RoundProposers)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
